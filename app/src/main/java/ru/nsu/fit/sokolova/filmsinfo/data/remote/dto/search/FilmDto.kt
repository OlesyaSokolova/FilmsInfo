...
data class FilmDto(
	val description: String, val id: String,//imdbTitleId
	val image: String, val resultType: String, val title: String
)

fun FilmDto.toSearchedFilm(): SearchedFilm {
	return SearchedFilm(
		description = description, imdbTitleId = id, title = title
	)
}